...
<?php get_header(); ?>
<?php query_posts('category_name=News&post_type=post&post_status=publish&posts_per_page=6&paged='. get_query_var('paged')); ?>

    <div class="row conpadding">
        <div class="eight columns">
        <div class="latest"> Latest News from Holland & Knight: </div>
        <br />
            <?php if (have_posts()) : 
